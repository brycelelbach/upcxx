...
namespace upcxx
{
  static gasnet_handlerentry_t AMtable[] = {
    ...
    /* array_bulk.c */
    {ARRAY_DELETE_AM,         (void (*)())array_delete_am},
    {ARRAY_ALLOC_AM,          (void (*)())array_alloc_am},
    {ARRAY_ALLOC_REPLY,       (void (*)())array_alloc_reply},
    {ARRAY_PACK_AM,           (void (*)())array_strided_pack_am},
    {ARRAY_PACK_REPLY,        (void (*)())array_strided_pack_reply},
    {ARRAY_UNPACKALL_AM,      (void (*)())array_strided_unpackAll_am},
    {ARRAY_UNPACK_REPLY,      (void (*)())array_strided_unpack_reply},
    {ARRAY_UNPACKONLY_AM,     (void (*)())array_strided_unpackOnly_am},
    // {ARRAY_SSCATTER_AM,       (void (*)())array_simpleScatter_am},
    // {ARRAY_SPARSE_REPLY,      (void (*)())array_sparse_done_reply},
    // {ARRAY_GSCATTER_AM,       (void (*)())array_generalScatter_am},
    // {ARRAY_SGATHER_AM,        (void (*)())array_simpleGather_am},
    // {ARRAY_SGATHER_REPLY,     (void (*)())array_simpleGather_reply},
    // {ARRAY_GGATHER_AM,        (void (*)())array_generalGather_am},
